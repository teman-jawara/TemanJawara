    ...
    <div class="profile-chip" id="profileChip" tabindex="0">
      ...
      <div class="profile-dropdown" id="profileDropdown">
        <div class="dropdown-header">
          <div class="full-name">{{ Auth::user()->name }}a Fredic</div>
...
<div class="layout">
  ...
  <a class="nav-item active" href="{{ route('postpage') }}">
  ...
  <main class="feed">
    ...
    <div class="compose-card">
      <div class="compose-top">
        <div class="compose-avatar">
          <img src="{{ asset('image/angel.jpg') }}" alt="{{ Auth::user()->name }}" class="composer-avatar-img">
        </div>
        <input class="compose-input" type="text" placeholder="Ketik sesuatu" />
      </div>
      <div class="compose-actions">
        <!-- Video icon -->
        <button class="compose-btn" title="Video">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3" class="compose-icon"/></svg>
        </button>
        <!-- Image icon -->
        <button class="compose-btn" title="Gambar">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5" class="compose-icon"/><polyline points="21 15 16 10 5 21"/></svg>
        </button>
    ...
    <div class="post-card">
      <div class="post-header">
        ...
        <div class="post-meta">
          <div class="post-name">Angeline Karin <span>🏅</span></div>
